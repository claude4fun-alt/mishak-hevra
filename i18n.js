...
(function (global) {
  ...
  var DICT = {
    ...
    'lib.newPack':            { he: '➕ חבילה חדשה', en: '➕ New pack', it: '➕ Nuovo pacchetto' },
    ...
    'lib.editList':           { he: '✏️ ערוך שאלות בטאב "שאלות"', en: '✏️ Edit questions in the "Questions" tab', it: '✏️ Modifica le domande nella scheda "Domande"' },
    ...
    'dash.savedMsg':          { he: 'נשמר ✓', en: 'Saved ✓', it: 'Salvato ✓' },
    ...
    'billing.payNow':         { he: 'תשלום מאובטח עם PayPal', en: 'Secure payment with PayPal', it: 'Pagamento sicuro con PayPal' },
